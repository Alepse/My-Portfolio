    ...
    <ThemeContext.Provider value={{ darkMode, setDarkMode }}>
      ...
      <div
        className={`min-h-screen transition-all duration-300 ${
          darkMode ? "bg-gray-900 text-white" : "bg-[#F5F7F8] text-gray-900"
        }`}
      >
          ...
          <main className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <div className="flex justify-center gap-2 md:gap-4 mb-6 md:mb-8 flex-wrap px-2 md:px-0">
                {["All", "Frontend", "Backend", "Design", "Tools"].map(
                  (category) => (
                    <motion.button
                      key={category}
            ...
            >
              <div className="max-w-4xl mx-auto text-center">
                ...
                <motion.p
                  ...
                  animate={{ y: 0, opacity: 1 }}
                  transition={{ delay: 0.2 }}
                  className={`text-sm md:text-lg mb-8 md:mb-12 ${
                    darkMode ? "text-gray-300" : "text-gray-600"
                  }`}
                >
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                  ...
                  >
                    Web developer focused on creating intuitive and engaging web
                    experiences. Currently studying at Bicol University.
                  </p>
                </div>
                {/* Quick Links */}
                <div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                  ...
                  >
                    © {new Date().getFullYear()} Kenneth Espela. All rights
                    reserved.
                  </p>
